      ...
      <div
        className={
          show
            ...
            : "bg-black fixed top-0 left-0 right-0 h-screen z-20 bg-opacity-50 hidden"
        }
      />
      <div className="fixed top-0 left-0 right-0 h-screen z-20 flex justify-center items-start p-5">
